...
TppCollection={
  ...
  TYPE_STATION=130,
  GetTypeIdByLocatorName=function(...)end,
  GetUniqueIdByLocatorName=function(...)end,
  IsDiamondByType=function(...)end,
  IsExistLocator=function(...)end,
  IsHerbByType=function(...)end,
  IsMaterialByType=function(...)end,
  RepopCountOperation=function(...)end,
  ResetMoved=function(...)end,
  SetAllCollectionInvisible=function(...)end,
  SetDisabledInGame=function(...)end,
  SetScriptDeclVars=function(...)end,
  SetValidStation=function(...)end,
}--this
