...
function this.DumpVars()
  ...
  local rootArrayIdent=-285212671--tex table itself is array

  local arrayIdent=-285212665--tex a table key is an array
  local arrayCountIdent=-285212666 --tex name of foxtable key for size of array,number of array names
